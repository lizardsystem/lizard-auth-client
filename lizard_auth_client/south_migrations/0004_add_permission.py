"""
Note: this is the 0003 migration (in the migrations folder) but converted
to South because we want to be compatible with older Django apps.
"""
...
class Migration(DataMigration):
    ...
    models = {
        ...
        'lizard_auth_client.role': {
            'Meta': {'ordering': "[u'unique_id']", 'object_name': 'Role'},
        ...
        'lizard_auth_client.userorganisationrole': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'organisation': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'user_organisation_roles'", 'to': "orm['lizard_auth_client.Organisation']"}),
            'role': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'user_organisation_roles'", 'to': "orm['lizard_auth_client.Role']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'user_organisation_roles'", 'to': "orm['auth.User']"})
        }
    }
