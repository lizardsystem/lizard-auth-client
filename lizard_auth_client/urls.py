...
def check_settings():
    ...
    if settings.SSO_USE_V2_LOGIN:
        ...
        if (
            not settings.SSO_SERVER_PUBLIC_URL or not settings.SSO_SERVER_PRIVATE_URL
        ):  # noqa: W503
            raise ImproperlyConfigured(
